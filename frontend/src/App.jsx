          ...
          <Marker key={spot.id} position={[spot.latitude, spot.longitude]}>
            <Popup>
              <div style={{ fontSize: '14px' }}>
                ...
                <span style={{ color: spot.status === 'Tersedia' ? 'green' : 'red', fontWeight: 'bold' }}>{spot.status}</span>
                <br />
                <small style={{ color: '#666' }}>Jarak: {Math.round(spot.distance_meters)} meter</small>
              </div>
            </Popup>
          </Marker>
        ))}
